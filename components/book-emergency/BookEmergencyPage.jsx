    ...
    <div className={`mnav ${open ? "open" : ""}`} onClick={onClose}>
      <div className="mnav-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mnav-cta">
          <a className="btn btn-cta" href="/book-appointment" onClick={onClose}>Book Appointment</a>
    ...
    <div className="rio booking-page">
      ...
      <header className={`header ${solid ? "solid" : ""}`}>
        ...
        <div className="nav-cta">
          ...
          <a className="btn btn-cta btn-sm" href="/book-appointment">Book Appointment</a>
        </div>
