...
const GP = {
  ...
  gallery: [
    { img: "newborn-care", cap: "Child-friendly OPD" },
    { img: "expert-specialists", cap: "Paediatric consultation room" },
    { img: "emergency", cap: "24/7 paediatric care" },
    { img: "expert-specialists2", cap: "Growth & development checks" },
  ],
  ...
  covers: [
    "Fever, cough & cold", "Infections", "Asthma & allergies", "Stomach & digestion issues",
    "Growth & nutrition", "Vaccination & immunisation", "Developmental check-ups", "Newborn to 18-year care",
  ],
  features: [
    { icon: "bell", title: "24/7 outpatient care", desc: "Paediatric consultation available around the clock for every childhood illness." },
    { icon: "heart", title: "Child-friendly environment", desc: "A warm, reassuring space designed to put children and parents at ease." },
    { icon: "team", title: "Experienced paediatricians", desc: "Expert doctors caring for children from birth right through to 18 years." },
    { icon: "scan", title: "Growth & development tracking", desc: "Regular monitoring of growth, milestones and nutrition to keep your child thriving." },
    { icon: "nicu", title: "Specialist & ICU backup", desc: "Seamless access to super-speciality and NICU/PICU care if your child needs more." },
    { icon: "power", title: "Vaccination & reminders", desc: "On-schedule immunisation with free SMS reminders, so nothing is missed." },
  ],
  stat: { n: "6 Lacs+", l: "Children & families cared for" },
  faqs: [
  ...
  related: [
    { name: "Vaccination Services", slug: "vaccination", img: "expert-specialists" },
    { name: "Paediatric Emergency", slug: "emergency", img: "emergency" },
    { name: "PICU", slug: "picu", img: "critical-care3" },
  ],
};
...
function GeneralPaediatricsPageContent({ service: s }) {
...
export default function GeneralPaediatricsPage() { return <GeneralPaediatricsPageContent service={GP} />; }
