...
const IVF = {
  slug: "fertility-ivf",
  gallery: [
    { img: "maternity-care", cap: "Fertility & reproductive care suite" },
    { img: "critical-care2", cap: "Follicular study & scan room" },
    { img: "expert-specialists2", cap: "Fertility consultation room" },
    { img: "newborn-care", cap: "Continuity into maternity care" },
  ],
...
export default function FertilityIvfPage() { return <FertilityIvfPageContent service={IVF} />; }
