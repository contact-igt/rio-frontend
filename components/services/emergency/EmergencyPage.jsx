...
const PE = {
  ...
  intro: [
    ...
    "Backed by an advanced NICU and PICU in the same hospital, emergencies are met with immediate, expert attention and seamless escalation to intensive care the moment it's needed.",
  ],
  covers: [
    "Sudden high fever & seizures", "Accidents & injuries", "Breathing difficulty", "Severe dehydration",
    "Poisoning & ingestion", "Allergic reactions", "Sudden critical illness", "Newborn emergencies",
  ],
  features: [
    { icon: "bell", title: "Open 24/7, every day", desc: "Round-the-clock casualty care across all four branches — no appointment needed in an emergency." },
  ...
  faqs: [
    { q: "When should I bring my child to emergency?", a: "For sudden high fever or seizures, breathing difficulty, accidents or injuries, severe dehydration, poisoning, allergic reactions, or any sudden critical illness — come in immediately or call our 24/7 line." },
    { q: "Is the emergency open at night?", a: "Yes. Paediatric emergency is open 24 hours a day, every day, across all four branches." },
    { q: "Do you have intensive care if my child needs it?", a: "Yes. An advanced NICU and PICU are on site, so critically ill children are escalated to intensive care immediately." },
    { q: "Do I need an appointment for an emergency?", a: "No. In an emergency, come straight in or call +91 77083 18222 — our team will be ready." },
  ],
  related: [
...
function EmergencyPageContent({ service: s }) {
...
export default function EmergencyPage() { return <EmergencyPageContent service={PE} />; }
