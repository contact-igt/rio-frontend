...
const IMG = {
  ...
  "critical-care4": "/assets/human-milk-bank/human-milk-bank.png",
  "critical-care2": "/assets/human-milk-bank/diagnostic-suite.png",
  "expert-specialists": "/assets/human-milk-bank/specialist-team.png",
  "Advanced-NICU": "/assets/human-milk-bank/neonatal-intensive-care.png",
  "maternity-care": "/assets/human-milk-bank/womens-care.png",
  "newborn-care": "/assets/human-milk-bank/child-newborn-care.png",
};
const LINKS = {
...
const HMB = {
  ...
  gallery: [
    { img: "critical-care4", cap: "Human Milk Bank — pasteurisation unit" },
    { img: "critical-care2", cap: "Sterile storage & cold chain" },
    { img: "expert-specialists", cap: "Donor counselling room" },
    { img: "Advanced-NICU", cap: "Linked NICU feeding support" },
  ],
  ...
  covers: [
    ...
    "Screened & pasteurised donor milk", "Sterile storage & cold chain", "Donor mother counselling",
    "Recipient family guidance", "Operational 365 days a year",
  ],
  features: [
  ...
  related: [
    ...
    { name: "Maternity Care", slug: "maternity", img: "newborn-care" },
  ],
};
...
function HumanMilkBankPageContent({ service: s }) {
...
export default function HumanMilkBankPage() { return <HumanMilkBankPageContent service={HMB} />; }
